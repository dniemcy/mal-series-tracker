...
export class AnimeService {
  ...
  private progressCallback: (() => void) | null;
  ...
  async fetchAnimeDetails(animeId: number | string): Promise<Anime> {
  ...
  async fetchAnimeList(username: string, isAuthenticated: boolean): Promise<AnimeListResponse> {
  ...
  async fetchMALClientId(): Promise<void> {
